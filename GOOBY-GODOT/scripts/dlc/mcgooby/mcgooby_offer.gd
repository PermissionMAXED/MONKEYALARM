...
extends RefCounted
## Das McGooby-Kauf-Angebot (Welle B, Doc §6.2) — GoobyeOffer als Code-
## Vorlage: der Kauf passiert DIREKT im Sheet („Grundstück kaufen!“),
## danach geht es sofort in die erste Schicht. „Später“ merkt sich den
## Stand (mcgooby.besitz.angebotVerschoben); das Angebot bleibt über den
## DLC-Hub erreichbar.
##
...
## „Grundstück kaufen!“: atomarer Kauf; Erfolg klingt nach ui_buy und
## reist in die Schicht, „zu wenig Münzen“ nach ui_error mit Klartext-Zeile.
