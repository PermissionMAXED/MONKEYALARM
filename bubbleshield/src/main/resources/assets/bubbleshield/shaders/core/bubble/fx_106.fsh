...
// v12 realism (1.21.1): glass tint 0.3142+Beer 0.6212*chord | energy 0.2976+0.3996*p | flow 0.104167 c/s | floor 0.3861
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.6212 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.3142);
    ...
    bodyAlpha = max(bodyAlpha, 0.3861);
