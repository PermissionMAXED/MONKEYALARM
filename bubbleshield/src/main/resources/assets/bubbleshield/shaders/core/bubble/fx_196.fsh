...
// v12 realism (1.21.1): glass tint 0.3071+Beer 0.4397*chord | energy 0.2425+0.4815*p | flow 0.073333 c/s | floor 0.3753
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.4397 * chordN * (1.0 - baseCol));
