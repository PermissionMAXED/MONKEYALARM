...
// v12 realism (1.21.1): glass tint 0.1133+Beer 0.5101*chord | energy 0.1542+0.3909*p | flow 0.072500 c/s | floor 0.3899
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.5101 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.1133);
