...
// v12 realism (1.21.1): glass tint 0.3068+Beer 0.8162*chord | energy 0.2309+0.4165*p | flow 0.091667 c/s | floor 0.3802
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.8162 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.3068);
    ...
    bodyAlpha = max(bodyAlpha, 0.3802);
