...
// v12 realism (1.21.1): glass tint 0.1399+Beer 0.5228*chord | energy 0.2051+0.4645*p | flow 0.097500 c/s | floor 0.3894
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.5228 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.1399);
