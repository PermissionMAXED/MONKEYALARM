...
// v12 realism (1.21.1): glass tint 0.1409+Beer 0.4523*chord | energy 0.1995+0.4145*p | flow 0.107500 c/s | floor 0.3853
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.4523 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.1409);
    ...
    bodyAlpha = max(bodyAlpha, 0.3853);
