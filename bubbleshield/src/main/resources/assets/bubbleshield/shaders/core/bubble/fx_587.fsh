...
// v12 realism (1.21.1): glass tint 0.1680+Beer 0.4420*chord | energy 0.1766+0.4241*p | flow 0.117500 c/s | floor 0.3970
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.4420 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.1680);
    ...
    bodyAlpha = max(bodyAlpha, 0.3970);
