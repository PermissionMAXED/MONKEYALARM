...
// v12 realism (1.21.1): glass tint 0.1418+Beer 0.7767*chord | energy 0.1486+0.3794*p | flow 0.103333 c/s | floor 0.3606
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.7767 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.1418);
