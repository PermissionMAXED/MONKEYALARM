...
// v12 realism (1.21.1): glass tint 0.2430+Beer 0.9213*chord | energy 0.2044+0.4210*p | flow 0.077500 c/s | floor 0.3605
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.9213 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.2430);
