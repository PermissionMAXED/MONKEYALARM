...
// v12 realism (1.21.1): glass tint 0.1174+Beer 0.5102*chord | energy 0.1725+0.4494*p | flow 0.100833 c/s | floor 0.3924
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.5102 * chordN * (1.0 - baseCol));
