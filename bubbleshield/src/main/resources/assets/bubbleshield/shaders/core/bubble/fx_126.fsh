...
// v12 realism (1.21.1): glass tint 0.2087+Beer 0.3976*chord | energy 0.2382+0.4632*p | flow 0.055833 c/s | floor 0.3551
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.3976 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.2087);
