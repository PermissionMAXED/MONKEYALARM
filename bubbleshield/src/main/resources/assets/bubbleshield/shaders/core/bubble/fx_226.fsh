...
// v12 realism (1.21.1): glass tint 0.1884+Beer 0.6799*chord | energy 0.2836+0.4314*p | flow 0.074167 c/s | floor 0.3419
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.6799 * chordN * (1.0 - baseCol));
    glassCol *= mix(vec3(1.0), baseCol, 0.1884);
