...
// v12 realism (1.21.1): glass tint 0.2015+Beer 0.7133*chord | energy 0.2674+0.4181*p | flow 0.054167 c/s | floor 0.3799
...
void main() {
    ...
    vec3 glassCol = baseCol * exp(-0.7133 * chordN * (1.0 - baseCol));
    ...
    bodyAlpha = max(bodyAlpha, 0.3799);
